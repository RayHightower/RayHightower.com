...
Overall, I like the Pine64. I expect the browser (or DMA?) bug to be resolved soon. And it's good to have a new quad-core 64-bit platform where parallelism can be explored.
